            ...
            <div className="my-6 mx-10">
                <div role="tablist" className="tabs tabs-lifted">
                    ...
                    <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6 py-16">
                        ...
                        <div className="grid gap-x-7 xl:gap-x-14 mx-1 xl:mx-4 gap-y-7 grid-cols-2 xl:grid-cols-3 mt-4">
                            {
                    ...
                    <ul className="w-full mb-4 steps steps-vertical lg:steps-horizontal">
                        ...
                        <div className="grid gap-x-2 xl:gap-x-14 mx-1 xl:mx-4 gap-y-7 grid-cols-2 xl:grid-cols-3 mt-4">
                            {
