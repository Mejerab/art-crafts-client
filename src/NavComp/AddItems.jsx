...
const AddItems = () => {
    ...
    return (
        <div className="my-8">
            <h3 className="text-center text-3xl font-semibold my-12">Add your craft</h3>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between mx-2 lg:mx-24 xl:mx-44 items-center">
                        <div className="flex items-center">
                            ...
                            <input type="text" className="text-sm my-6 sm:-ml- sm:w-[40%] input input-bordered" name="time" placeholder="Craft processing time" required />
                        </div>
                        <div className="flex items-center">
